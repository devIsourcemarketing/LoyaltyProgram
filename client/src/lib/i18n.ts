const translations = {
  en: {
    validation: {
      ...
      usernameMinCharacters: "Username must be at least 3 characters",
      passwordMinCharacters: "Password must be at least 6 characters",
      firstNameMinCharacters: "First name must be at least 2 characters",
      lastNameMinCharacters: "Last name must be at least 2 characters",
      emailInvalid: "Invalid email address",
      countryRequired: "Country is required",
      passwordsDontMatch: "Passwords don't match",
      currentPasswordRequired: "Current password is required",
      newPasswordMinCharacters: "New password must be at least 6 characters",
    },
    loginScreen: {
    ...
    common: {
      ...
      noRewardAssigned: "No reward assigned",
      currentReward: "Current Reward",
      changeReward: "Change Reward",
      noRegionsConfigured: "No regions configured",
      createRegionalConfigFirst: "First you must create regional configurations in the \"Configurations\" tab",
      ...
      registrationRequiredDesc: "No account exists with this email. Please complete your registration.",
      activationFailed: "Activation Failed",
      activatingAccount: "Activating Your Account...",
      welcomeToProgram: "Welcome to Loyalty Program!",
      pleaseWaitSetup: "Please wait while we set up your account",
      accountReadyRedirecting: "Your account is ready. Redirecting...",
      problemWithInvitation: "There was a problem with your invitation",
      ...
      imageFormatAndSize: "PNG, JPG or WEBP (max 2MB)",
      ...
      failedToApproveDeal: "Failed to approve deal",
      failedToRejectDeal: "Failed to reject deal",
      failedToDeleteDeal: "Failed to delete deal",
      failedToUpdateUserRole: "Failed to update user role",
      failedToCreateUser: "Failed to create user",
      failedToUpdateUser: "Failed to update user",
      failedToDeleteUser: "Failed to delete user",
      failedToProcessCSV: "Failed to process users CSV file",
      failedToApproveUser: "Failed to approve user",
      failedToRejectUser: "Failed to reject user",
      failedToUpdateShipment: "Failed to update shipment status",
      failedToApproveRedemption: "Failed to approve redemption",
      failedToRejectRedemption: "Failed to reject redemption",
      failedToDeleteReward: "Failed to delete reward",
      failedToLoadRegionHierarchy: "Failed to load region hierarchy",
      ...
      passwordRequiredToLogin: "Password required",
      pleaseEnterValidEmail: "Please enter a valid email",
      youNeedPointsToRedeem: "You need {points} points to redeem this reward.",
      registrationError: "Error completing registration",
      couldNotCompleteRegistration: "Could not complete registration",
      accountReady: "Your account is ready. You can now log in.",
      regionAutoAssigned: "Your account is ready. The region {region} from which you were invited was automatically assigned. You can now log in.",
      registrationError: "Error completing registration",
      couldNotCompleteRegistration: "Could not complete registration",
      accountReady: "Your account is ready. You can now log in.",
      regionAutoAssigned: "Your account is ready. The region {region} from which you were invited was automatically assigned. You can now log in.",
    ...
    auth: {
      ...
      verifyingAccess: "Verifying your access link...",
      redirectingToDashboard: "Redirecting to dashboard...",
      verifyingInvitationStatus: "Verifying invitation...",
      creatingYourAccount: "Creating your account...",
      settingUpAccess: "Setting up access...",
    ...
    rewards: {
      ...
      activeStatusDescription: "Inactive rewards won't be visible to users",
      rewardNamePlaceholder: "$100 Amazon Gift Card",
      pointsCostPlaceholder: "10000",
      descriptionPlaceholder: "Detailed description of the reward...",
      stockPlaceholder: "100",
      displayOrderPlaceholder: "15",
    },
    profile: {
      ...
      manageAccountSettings: "Manage your account settings and personal information",
    ...
    support: {
      ...
      terms: {
        ...
        MEXICO: {
          title: "Términos y Condiciones - Programa Kaspersky Cup",
          subtitle: "Fecha de vigencia: Diciembre 2025",
          content: `<div class="space-y-4">
            <h3 class="font-semibold text-lg">1. Organización</h3>
            <p>El programa Kaspersky Cup (en adelante, “el Programa”) es organizado por Kaspersky con el objetivo de reconocer y premiar el desempeño de ventas de sus socios comerciales en la región, mediante un sistema de acumulación de goles que pueden canjearse por premios mensuales y un Gran Premio final por categoría de Partner, segmento de mercado y región.</p>
            
            <h3 class="font-semibold text-lg">2. Vigencia</h3>
            <p>El Programa inicia en diciembre de 2025 y finaliza con la entrega del Gran Premio al máximo goleador por categoría de Partner, segmento de mercado y región, prevista para abril de 2026, salvo que Kaspersky anuncie una prórroga oficial.</p>
    ...
    dashboard: {
      ...
      noDealsFound: "No deals found. Register your first deal to get started!",
      page: "Page",
      of: "of",
      points: "points",
      loading: "...",
      ...
      next: "Next",
      bigPrize: "Big Prize",
      bigPrizeSubtitle: "Experience the 2026 FIFA World Cup!",
      bigPrizeText: "Win an epic experience at New York New Jersey Stadium on June 30, 2026",
      includes: "Includes:",
      includesText1 : "One (1) single entry for the game",
      includesText2 : "Round-trip flights",
      includesText3 : "Lodging",
      includesText4 : "Complete nutrition",
      bigPrizeFinalText: "Get ready to experience football like never before.",
      bigPrizeFinalTitle: "This could be your moment!",
    },
    deals: {
      newDeal: "New Deal",
      editDeal: "Edit Deal",
    ...
    rewards: {
      ...
      approved: "Approved - Pending Delivery",
      delivered: "Delivered",
    ...
    admin: {
      ...
      // Grand Prize Card
      yourGrandPrize: "Your Grand Prize",
      firstPlace: "1st Place",
      secondPlace: "2nd Place",
      thirdPlace: "3rd Place",
      nthPlace: "{position}th Place",
      location: "Location",
      eventDate: "Event Date",
      round: "Round",
      competitionPeriod: "Competition Period",
      qualifyForPrize: "Reach the top position in your category to qualify for this prize!",
      // Grand Prize Tab
      prizeSegmentation: "Prize Segmentation (Optional)",
      prizeSegmentationDesc: "Filter this prize by market segment, partner category, or subregion. Leave empty to apply to all.",
      marketSegment: "Market Segment",
      ...
      subregionPlaceholder: "e.g., COLOMBIA, CENTRO AMERICA, COLOMBIA & CENTRO AMÉRICA",
      subregionHelp: "For multiple subregions, use \"&\" separator (e.g., \"COLOMBIA & CENTRO AMÉRICA\")",
      rankingPositionToWin: "Ranking Position to Win",
      rankingPositionHelp: "1 = First place, 2 = Second place, etc.",
      prizeDetails: "Prize Details (Language-Independent)",
      prizeDetailsDesc: "These details will be shown to users in their language context. Keep in English for consistency.",
      prizeDescription: "Prize Description",
      grandPrizeDescriptionPlaceholder: "Mayor Goleador - All-inclusive trip to World Cup",
      stadiumLocation: "Stadium/Location",
      stadiumPlaceholder: "New York New Jersey Stadium",
      notSpecified: "Not specified",
      eventDateLabel: "Event Date",
      eventDatePlaceholder: "June 30",
      tournamentRound: "Tournament Round",
      tournamentRoundPlaceholder: "32",
      redemptionStart: "Redemption Start",
      redemptionDeadline: "Redemption Deadline",
      activeCriterion: "Active Criterion",
      activeCriterionDesc: "Active criteria will be used to calculate the ranking",
      createNewCriterion: "Create New Criterion",
      allGrandPrizeCriteriaDesc: "All Grand Prize criteria (active and inactive)",
      currentRanking: "Current Ranking",
      usersOrderedByCriteria: "Users ordered according to defined criteria",
      noUsersMatchCriteria: "No users meet the current criteria",
      firstPlaceBadge: "1st",
      secondPlaceBadge: "2nd",
      thirdPlaceBadge: "3rd",
      // Error messages
      ...
      csvImport: {
        ...
        processing: "Processing deals...",
        importedDeals: "{count} deals imported successfully",
        successRate: "{rate}% success rate",
        totalRows: "Total rows: {count}",
        validDeals: "Valid deals: {count}",
        failedDeals: "Failed: {count}",
        errors: "Errors",
        errorTypes: {
          duplicate: "Duplicate deals",
  ...
  es: {
    validation: {
      ...
      usernameMinCharacters: "El nombre de usuario debe tener al menos 3 caracteres",
      passwordMinCharacters: "La contraseña debe tener al menos 6 caracteres",
      firstNameMinCharacters: "El nombre debe tener al menos 2 caracteres",
      lastNameMinCharacters: "El apellido debe tener al menos 2 caracteres",
      emailInvalid: "Correo electrónico inválido",
      countryRequired: "El país es requerido",
      passwordsDontMatch: "Las contraseñas no coinciden",
      currentPasswordRequired: "La contraseña actual es requerida",
      newPasswordMinCharacters: "La nueva contraseña debe tener al menos 6 caracteres",
    },
    loginScreen: {
    ...
    common: {
      ...
      dealRejected: "Negocio rechazado",
      ...
      dealManagement: "Gestión de Deals",
      csvFile: "Archivo CSV",
      selectReward: "Selecciona un reward",
      noReward: "Sin reward",
      noRewardsAvailable: "No hay rewards disponibles",
      noRewardAssigned: "Sin reward asignado",
      currentReward: "Reward Actual",
      changeReward: "Cambiar Reward",
      noRegionsConfigured: "No hay regiones configuradas",
      createRegionalConfigFirst: "Primero debes crear configuraciones regionales en la pestaña \"Configuraciones\"",
      withExpirationDate: "Con fecha de caducidad",
      allRegionsLabel: "Todas las Regiones",
      superAdmin: "Super Admin",
      dealsImported: "deals importados",
      ...
      registrationRequiredDesc: "No existe una cuenta con este email. Por favor, complete su registro.",
      activationFailed: "Activación Fallida",
      activatingAccount: "Activando Su Cuenta...",
      welcomeToProgram: "¡Bienvenido al Programa de Lealtad!",
      pleaseWaitSetup: "Por favor, espere mientras configuramos su cuenta",
      accountReady: "Su cuenta está lista. Redirigiendo...",
      problemWithInvitation: "Hubo un problema con su invitación",
      ...
      updateReward: "Actualizar Premio",
      createReward: "Crear Premio",
      uploading: "Subiendo...",
      uploadImage: "Subir Imagen",
      clickToUploadImage: "Click para subir imagen",
      imageFormatAndSize: "PNG, JPG o WEBP (máx 2MB)",
      failedToGetUploadURL: "Error al obtener URL de carga",
      ...
      failedToApproveDeal: "Error al aprobar el deal",
      failedToRejectDeal: "Error al rechazar el deal",
      failedToDeleteDeal: "Error al eliminar el deal",
      failedToUpdateUserRole: "Error al actualizar el rol del usuario",
      ...
      failedToProcessCSV: "Error al procesar archivo CSV de usuarios",
      failedToApproveUser: "Error al aprobar usuario",
      failedToRejectUser: "Error al rechazar usuario",
      failedToUpdateShipment: "Error al actualizar estado de envío",
      failedToApproveRedemption: "Error al aprobar canje",
      failedToRejectRedemption: "Error al rechazar canje",
      failedToDeleteReward: "Error al eliminar reward",
      failedToLoadRegionHierarchy: "Error al cargar jerarquía de regiones",
      failedToUpdateProfile: "Error al actualizar perfil",
      failedToChangePassword: "Error al cambiar contraseña",
      failedToSendMagicLink: "Error al enviar enlace mágico",
      failedToRedeemReward: "Error al canjear reward",
      ...
      pleaseEnterPasswordToContinue: "Por favor, ingrese su contraseña para continuar",
      passwordRequiredToLogin: "Contraseña requerida",
      pleaseEnterValidEmail: "Por favor ingrese un correo electrónico válido",
      youNeedPointsToRedeem: "Necesita {points} goles para canjear este reward.",
      registrationError: "Error al completar el registro",
      couldNotCompleteRegistration: "No se pudo completar el registro",
      accountReady: "Su cuenta está lista. Ya puede iniciar sesión.",
      regionAutoAssigned: "Su cuenta está lista. Se le asignó automáticamente la región {region} desde donde fue invitado. Ya puede iniciar sesión.",
      facebook: "https://facebook.com/kaspersky",
      twitter: "https://twitter.com/kaspersky",
      linkedin: "https://linkedin.com/company/kaspersky-lab",
      youtube: "https://youtube.com/kaspersky",
    ...
    auth: {
      ...
      verifyingAccess: "Verificando su enlace de acceso...",
      redirectingToDashboard: "Redirigiendo al dashboard...",
      verifyingInvitationStatus: "Verificando invitación...",
      creatingYourAccount: "Creando tu cuenta...",
      settingUpAccess: "Configurando acceso...",
      selectCountry: "Selecciona tu país",
      usernameLabel: "Nombre de Usuario",
    },
    rewards: {
      rewardName: "Nombre del Reward",
      pointsCost: "Costo en Puntos",
      stockQuantity: "Cantidad en Stock (Opcional)",
      activeStatus: "Estado Activo",
      activeStatusDescription: "Los rewards inactivos no serán visibles para los usuarios",
      rewardNamePlaceholder: "$100 Tarjeta de Regalo Amazon",
      pointsCostPlaceholder: "10000",
      descriptionPlaceholder: "Descripción detallada del reward...",
      stockPlaceholder: "100",
      displayOrderPlaceholder: "15",
    },
    profile: {
      ...
      personalInfoDescription: "Actualiza tus datos personales e información de contacto",
      security: "Seguridad",
      ...
      manageAccountSettings: "Administra la configuración de tu cuenta e información personal",
      countryPlaceholder: "Estados Unidos",
      currentPasswordPlaceholder: "Ingrese su contraseña actual",
      newPasswordPlaceholder: "Ingrese nueva contraseña (mín. 6 caracteres)",
    ...
    dashboard: {
      ...
      noDealsFound: "No se encontraron tratos. ¡Registra tu primer trato para comenzar!",
      page: "Página",
      of: "de",
      points: "puntos",
      loading: "...",
      ...
      product: "Producto",
      status: "Estado",
      pendingDeals: "Negocios pendientes",
      ...
      previous: "Anterior",
      next: "Siguiente",
      bigPrize: "Premio Mayor",
      bigPrizeSubtitle: "¡Viva el Mundial FIFA 2026!",
      bigPrizeText: "Gane una experiencia épica en el New York New Jersey Stadium este 30 de junio de 2026",
      includes: "Incluye:",
      includesText1 : "Una (1) entrada individual para el partido",
      includesText2 : "Vuelos de ida y vuelta",
      includesText3 : "Hospedaje",
      includesText4 : "Alimentación completa",
      bigPrizeFinalText: "Prepárese para vivir el fútbol como nunca antes.",
      bigPrizeFinalTitle: "¡Este puede ser su momento!",
    },
    deals: {
      newDeal: "Nuevo Negocio",
      editDeal: "Editar Negocio",
      registerNewDeal: "Registrar Nuevo Negocio",
    ...
    rewards: {
      ...
      inExchange: "En canje",
      approved: "Aprobado - Pendiente de Entrega",
      delivered: "Entregado",
    ...
    admin: {
      ...
      rewardHistory: "Historial de Premios",
      reports: "Reportes",
      ...
      approveDeals: "Apruebe y rastree Negocios",
      ...
      rewardManagement: "Gestión de Premios",
      approveRewardRedemptions: "Apruebe canjes de Premios y gestiona envíos",
      rewardCatalog: "Catálogo de Premios",
      ...
      noRedemptionsToApproveDesc: "Todos los canjes de Premios han sido procesados",
      rewardName: "Nombre de Premio",
      ...
      noRedemptionHistoryDesc: "Aún no se han canjeado Premios",
      generateReports: "Generar Reportes",
      country: "País",
      allCountries: "Todos los Países",
      exportUserRanking: "Exportar Ranking de Usuarios (Excel)",
      exportRewardRedemptions: "Exportar Canjes de Premios (Excel)",
      exportDealsPerUser: "Exportar Tratos por Usuario (Excel)",
      viewAll: "Ver Todo",
      noPendingDeals: "No hay Negocios pendientes por revisar",
      ...
      round: "Ronda",
      competitionPeriod: "Período de Competencia",
      qualifyForPrize: "¡Alcanza la mejor posición en tu categoría para calificar a este premio!",
      // Grand Prize Tab
      prizeSegmentation: "Segmentación del Premio (Opcional)",
      prizeSegmentationDesc: "Filtre este premio por segmento de mercado, categoría de partner o subregión. Deje vacío para aplicar a todos.",
      ...
      subregionPlaceholder: "ej., COLOMBIA, CENTRO AMERICA, COLOMBIA & CENTRO AMÉRICA",
      subregionHelp: "Para múltiples subregiones, use el separador \"&\" (ej., \"COLOMBIA & CENTRO AMÉRICA\")",
      rankingPositionToWin: "Posición de Ranking para Ganar",
      rankingPositionHelp: "1 = Primer lugar, 2 = Segundo lugar, etc.",
      prizeDetails: "Detalles del Premio (Independiente del Idioma)",
      prizeDetailsDesc: "Estos detalles se mostrarán a los usuarios en el contexto de su idioma. Manténgalos en inglés para consistencia.",
      prizeDescription: "Descripción del Premio",
      grandPrizeDescriptionPlaceholder: "Mayor Goleador - All-inclusive trip to World Cup",
      stadiumLocation: "Estadio/Ubicación",
      stadiumPlaceholder: "New York New Jersey Stadium",
      ...
      tournamentRoundPlaceholder: "32",
      redemptionStart: "Inicio de Canje",
      redemptionDeadline: "Fecha Límite de Canje",
      activeCriterion: "Criterio Activo",
      activeCriterionDesc: "Los criterios activos se usarán para calcular el ranking",
      createNewCriterion: "Crear Nuevo Criterio",
      allGrandPrizeCriteriaDesc: "Todos los criterios del Gran Premio (activos e inactivos)",
      currentRanking: "Ranking Actual",
      usersOrderedByCriteria: "Usuarios ordenados según los criterios definidos",
      noUsersMatchCriteria: "No hay usuarios que cumplan con los criterios actuales",
      firstPlaceBadge: "1er",
      secondPlaceBadge: "2do",
      thirdPlaceBadge: "3er",
      // Error messages
      ...
      csvImport: {
        ...
        partialSuccessTitle: "Importación Parcial",
        errorTitle: "Error en Importación",
        uploading: "Subiendo CSV...",
        processing: "Procesando deals...",
        importedDeals: "{count} deals importados exitosamente",
        successRate: "{rate}% de éxito",
        totalRows: "Total de filas: {count}",
        validDeals: "Deals válidos: {count}",
        failedDeals: "Fallidos: {count}",
        errors: "Errores",
        errorTypes: {
          duplicate: "Deals duplicados",
          user_not_found: "Usuarios no encontrados",
          invalid_format: "Errores de formato",
          missing_field: "Campos faltantes",
          invalid_date: "Fechas inválidas",
        },
        firstErrors: "Primeros errores:",
  ...
  pt: {
    validation: {
      ...
      usernameMinCharacters: "O nome de usuário deve ter pelo menos 3 caracteres",
      passwordMinCharacters: "A senha deve ter pelo menos 6 caracteres",
      firstNameMinCharacters: "O nome deve ter pelo menos 2 caracteres",
      lastNameMinCharacters: "O sobrenome deve ter pelo menos 2 caracteres",
      emailInvalid: "E-mail inválido",
      countryRequired: "O país é obrigatório",
      passwordsDontMatch: "As senhas não coincidem",
      currentPasswordRequired: "A senha atual é obrigatória",
      newPasswordMinCharacters: "A nova senha deve ter pelo menos 6 caracteres",
    },
    loginScreen: {
    ...
    common: {
      ...
      registrationRequiredDesc: "Não existe uma conta com este email. Por favor, complete seu registro.",
      activationFailed: "Ativação Falhou",
      activatingAccount: "Ativando Sua Conta...",
      welcomeToProgram: "Bem-vindo ao Programa de Fidelidade!",
      pleaseWaitSetup: "Por favor, aguarde enquanto configuramos sua conta",
      accountReady: "Sua conta está pronta. Redirecionando...",
      problemWithInvitation: "Houve um problema com seu convite",
      completingRegistration: "Completando registro...",
      completeRegistration: "Completar Registro",
      ...
      updateReward: "Atualizar Prêmio",
      createReward: "Criar Prêmio",
      uploading: "Enviando...",
      uploadImage: "Enviar Imagem",
      clickToUploadImage: "Clique para enviar imagem",
      imageFormatAndSize: "PNG, JPG ou WEBP (máx 2MB)",
      failedToGetUploadURL: "Falha ao obter URL de upload",
      ...
      failedToApproveDeal: "Erro ao aprovar o negócio",
      failedToRejectDeal: "Erro ao rejeitar o negócio",
      failedToDeleteDeal: "Erro ao excluir o negócio",
      failedToUpdateUserRole: "Erro ao atualizar função do usuário",
      failedToCreateUser: "Erro ao criar usuário",
      failedToUpdateUser: "Erro ao atualizar usuário",
      failedToDeleteUser: "Erro ao excluir usuário",
      failedToProcessCSV: "Erro ao processar arquivo CSV de usuários",
      failedToApproveUser: "Erro ao aprovar usuário",
      failedToRejectUser: "Erro ao rejeitar usuário",
      failedToUpdateShipment: "Erro ao atualizar status de envio",
      failedToApproveRedemption: "Erro ao aprovar resgate",
      failedToRejectRedemption: "Erro ao rejeitar resgate",
      failedToDeleteReward: "Erro ao excluir recompensa",
      failedToLoadRegionHierarchy: "Erro ao carregar hierarquia de regiões",
      failedToUpdateProfile: "Erro ao atualizar perfil",
      failedToChangePassword: "Erro ao alterar senha",
      failedToSendMagicLink: "Erro ao enviar link mágico",
      failedToRedeemReward: "Erro ao resgatar recompensa",
      serverError: "Erro do servidor",
      pleaseTryAgain: "Por favor, tente novamente",
      pleaseLogInAgain: "Por favor, faça login novamente",
      adminAccount: "Conta de administrador",
      pleaseEnterPasswordToContinue: "Por favor, digite sua senha para continuar",
      passwordRequiredToLogin: "Senha necessária",
      pleaseEnterValidEmail: "Por favor, digite um e-mail válido",
      youNeedPointsToRedeem: "Você precisa de {points} gols para resgatar esta recompensa.",
      registrationError: "Erro ao concluir o registro",
      couldNotCompleteRegistration: "Não foi possível concluir o registro",
      accountReady: "Sua conta está pronta. Você já pode fazer login.",
      regionAutoAssigned: "Sua conta está pronta. A região {region} de onde você foi convidado foi atribuída automaticamente. Você já pode fazer login.",
    ...
    auth: {
      ...
      verifyingAccess: "Verificando seu link de acesso...",
      redirectingToDashboard: "Redirecionando para o dashboard...",
      verifyingInvitationStatus: "Verificando convite...",
      creatingYourAccount: "Criando sua conta...",
      settingUpAccess: "Configurando acesso...",
    ...
    rewards: {
      rewardName: "Nome do Reward",
      pointsCost: "Custo em Pontos",
      stockQuantity: "Quantidade em Estoque (Opcional)",
      activeStatus: "Status Ativo",
      activeStatusDescription: "Rewards inativos não serão visíveis para os usuários",
      rewardNamePlaceholder: "$100 Cartão Presente Amazon",
      pointsCostPlaceholder: "10000",
      descriptionPlaceholder: "Descrição detalhada da recompensa...",
      stockPlaceholder: "100",
      displayOrderPlaceholder: "15",
    },
    profile: {
      ...
      personalInfoDescription: "Atualize seus dados pessoais e informações de contato",
      security: "Segurança",
      ...
      manageAccountSettings: "Gerencie as configurações da sua conta e informações pessoais",
      countryPlaceholder: "Estados Unidos",
      currentPasswordPlaceholder: "Digite sua senha atual",
      newPasswordPlaceholder: "Digite nova senha (mín. 6 caracteres)",
...
`
    ...
    dashboard: {
      ...
      noDealsFound: "Nenhum negócio encontrado. Registre seu primeiro negócio para começar!",
      page: "Página",
      of: "de",
      points: "pontos",
      loading: "...",
      ...
      previous: "Antigo",
      next: "Seguindo",
      bigPrize: "Prêmio Principal",
      bigPrizeSubtitle: "Viva a Copa do Mundo FIFA 2026!",
      bigPrizeText: "Ganhe uma experiência épica no BC Place, Vancouver (Canadá) no dia 2 de julho de 2026",
      includes: "Inclui:",
      includesText1 : "Um (1) ingresso individual para a partida",
      includesText2 : "Passagens aéreas de ida e volta",
      includesText3 : "Hospedagem",
      includesText4 : "Alimentação completa",
      bigPrizeFinalText: "Prepare-se para viver o futebol como nunca antes.",
      bigPrizeFinalTitle: "Este pode ser o seu momento! ",
    },
    deals: {
    ...
    rewards: {
      ...
      claimReward: "Reivindicar Prêmios",
    ...
    admin: {
      ...
      csvImport: {
        ...
        uploading: "Enviando CSV...",
        processing: "Processando deals...",
        importedDeals: "{count} deals importados com sucesso",
        successRate: "{rate}% de sucesso",
        totalRows: "Total de linhas: {count}",
        validDeals: "Deals válidos: {count}",
        failedDeals: "Falhados: {count}",
        errors: "Erros",
        errorTypes: {
          duplicate: "Deals duplicados",
          user_not_found: "Usuários não encontrados",
          invalid_format: "Erros de formato",
          missing_field: "Campos ausentes",
          invalid_date: "Datas inválidas",
        },
        firstErrors: "Primeiros erros:",
        moreErrors: "...e {count} mais",
