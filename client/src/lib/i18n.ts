const translations = {
  en: {
    ...
    admin: {
      ...
      countryPlaceholder: "Colombia, México, etc.",
      passwordOptionalHint: "Leave blank if the user will use magic link",
  ...
  es: {
    ...
    common: {
      ...
      confirmDeleteDeal: "¿Estás seguro de que quieres eliminar este trato? Esta acción no se puede deshacer y quedará registrada en el historial de auditoría.",
    ...
    auth: {
      ...
      accountPendingApprovalMessage: "Tu cuenta está pendiente de aprobación. Un administrador debe aprobarla antes de que puedas acceder.",
      adminWillNotifyByEmail: "Un administrador debe aprobar tu cuenta antes de que puedas acceder. Te notificaremos por correo cuando esto suceda.",
      ...
      registrationCompleted: "Registro Completado",
      registrationPendingApproval: "Tu registro se completó exitosamente. Tu cuenta está pendiente de aprobación por un administrador.",
      youWillBeNotified: "Recibirás una notificación por correo cuando tu cuenta sea aprobada.",
    ...
    admin: {
      ...
      deleteRejectedUserConfirmation: "¿Estás seguro que deseas eliminar este usuario rechazado? Podrán registrarse nuevamente con el mismo correo.",
      ...
      countryPlaceholder: "Colombia, México, etc.",
      passwordOptionalHint: "Dejar en blanco si el usuario usará link mágico",
...
`
    ...
    admin: {
      ...
      countryPlaceholder: "Colômbia, México, etc.",
      passwordOptionalHint: "Deixe em branco se o usuário usar link mágico",
